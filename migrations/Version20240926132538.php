 ...
 */
final class Version20240926132538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entertainment (id INT AUTO_INCREMENT NOT NULL, entertainment_type_id INT NOT NULL, zone_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, max_number_seats INT DEFAULT NULL, duration INT DEFAULT NULL, on_reservation TINYINT(1) NOT NULL, is_canceled TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_5DCF0F53BCD84E39 (entertainment_type_id), INDEX IDX_5DCF0F539F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entertainment_schedule (id INT AUTO_INCREMENT NOT NULL, entertainment_id INT NOT NULL, duration INT DEFAULT NULL, start DATETIME NOT NULL, is_canceled TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_6C42CFCF84F8966A (entertainment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quest (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, zone_id INT NOT NULL, guild_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, infos LONGTEXT NOT NULL, points INT NOT NULL, type VARCHAR(255) NOT NULL, is_secret TINYINT(1) NOT NULL, password VARCHAR(255) DEFAULT NULL, INDEX IDX_4317F81771F7E88B (event_id), INDEX IDX_4317F8179F2C3FAB (zone_id), INDEX IDX_4317F8175F2131EF (guild_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rpg_table (id INT AUTO_INCREMENT NOT NULL, rpg_activity_id INT NOT NULL, duration INT DEFAULT NULL, start DATETIME NOT NULL, is_canceled TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_17CEDE7F444E139E (rpg_activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_tm (id INT AUTO_INCREMENT NOT NULL, guild_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, telephone VARCHAR(15) NOT NULL, name VARCHAR(255) NOT NULL, is_verified TINYINT(1) DEFAULT 0 NOT NULL, email_verification_hash_expire_at DATETIME DEFAULT NULL, email_verification_hash VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_21DE072DE7927C74 (email), INDEX IDX_21DE072D5F2131EF (guild_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reset_password_request ADD CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES user_tm (id)');
